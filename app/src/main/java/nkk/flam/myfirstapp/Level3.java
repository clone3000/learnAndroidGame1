...
public class Level3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Устанавливаем фон диалогового окна в конце игры - начало
        ...
        //Устанавливаем фон диалогового окна в конце игры - конец
        ...
        text_left.setText(array.texst3[numLeft]);//Достаем из массива текст

        numRight = random.nextInt(21); // Генерируем случайное число от 1 до 21
        ...
        text_right.setText(array.texst3[numRight]);//Достаем из массива текст
